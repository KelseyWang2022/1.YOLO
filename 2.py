...
days = (len(adjusted_data) // time_steps_per_day) + 1

# Plot the data for only Density and ST-Transformer
plt.figure(figsize=(12, 6))
plt.plot(adjusted_data['Density'], label='Density', linewidth=0.5)
...
plt.xticks(ticks=np.arange(0, days * time_steps_per_day, time_steps_per_day),
...
# Save the plot
st_transformer_visualization_path = "traffic_predictions_st_transformer_visualization_days_fixed.png"
